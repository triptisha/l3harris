...
var frappechart = function() {
    ...
    function k(t, e) {
        ...
        for (var n in e) {
            ...
            } else "styles" === n ? "object" === (void 0 === a ? "undefined" : Et(a)) && Object.keys(a).map(function(t) {
                i.style[t] = a[t]
    ...
    function S(t, e) {
        var i = arguments.length > 2 && void 0 !== arguments[2] && arguments[2],
            ...
            a = w(t, n),
            s = [1, .6, .2];
        return i && (s = [.4, .2, 0]), A(a, "0%", e, s[0]), A(a, "50%", e, s[1]), A(a, "100%", e, s[2]), n
    }
    ...
    function z(t, e, i) {
        var n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : "none",
            a = arguments[4];
        a = arguments.length > 5 && void 0 !== arguments[5] && arguments[5] ? v(a, te) : a;
        var s = {
    ...
    function F(t, e, i, n) {
        var a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : {};
        a.stroke || (a.stroke = ie), a.lineType || (a.lineType = ""), a.shortenNumbers && (e = g(e));
        var s = k("line", {
    ...
    function I(t, e, i) {
        var n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {};
        n.pos || (n.pos = "left"), n.offset || (n.offset = 0), n.mode || (n.mode = "span"), n.stroke || (n.stroke = ie), n.className || (n.className = "");
        var a = -1 * Qt,
            s = "span" === n.mode ? i + Qt : 0;
        return "tick" === n.mode && "right" === n.pos && (a = i + Qt, s = i), a += n.offset, s += n.offset, F(t, e, a, s, {
            stroke: n.stroke,
    ...
    function R(t, e, i) {
        var n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {};
        n.pos || (n.pos = "bottom"), n.offset || (n.offset = 0), n.mode || (n.mode = "span"), n.stroke || (n.stroke = ie), n.className || (n.className = "");
        var a = i + Qt,
            s = "span" === n.mode ? -1 * Qt : i;
        return "tick" === n.mode && "top" === n.pos && (a = -1 * Qt, s = 0), j(t, e, a, s, {
            stroke: n.stroke,
            className: n.className,
            lineType: n.lineType
        })
    ...
    function $(t, e, i, n) {
        ...
        return l -= a, "rect" !== t.nodeName ? [
            [t.childNodes[0], {
                width: n,
                height: o
            }, re, he], q(t, t.getAttribute("transform").split("(")[1].slice(0, -1), [e, l], le)
        ] : [
            [t, {
                width: n,
                height: o,
    ...
    function Q(t, e, i) {
        return "circle" !== t.nodeName ? [q(t, t.getAttribute("transform").split("(")[1].slice(0, -1), [e, i], le)] : [
            [t, {
                cx: e,
                cy: i
            }, re, he]
    ...
    function kt(t) {
        function e(t, e) {
            for (var i = xt(t), n = i[1] - i[0], a = 0, s = 1; a < e; s++) a += n, i.unshift(-1 * a);
            return i
        }
        ...
        if (n >= 0 && a >= 0) mt(n)[1], s = i ? xt(n, a) : xt(n);
            ...
            var r = Math.abs(a);
            n >= r ? (mt(n)[1], s = e(n, r)) : (mt(r)[1], s = e(r, n).map(function(t) {
                return -1 * t
            }))
        } else if (n <= 0 && a <= 0) {
            var o = Math.abs(a),
                l = Math.abs(n);
            mt(o)[1], s = (s = i ? xt(o, l) : xt(o)).reverse().map(function(t) {
                return -1 * t
            })
        }
        return s
    ...
    function Ct(t, e) {
        for (var i = Math.max.apply(Math, It(t)), n = 1 / (e - 1), a = [], s = 0; s < e; s++) {
            var r = i * (n * s);
            a.push(r)
        }
        return a
    ...
    function St() {
        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "line",
            e = arguments[1],
            i = arguments[2];
        return "axis-mixed" === t ? (i.type = "line", new Te(e, i)) : Oe[t] ? new Oe[t](e, i) : void console.error("Undefined chart type: " + t)
    }! function(t, e) {
        void 0 === e && (e = {});
        var i = e.insertAt;
    ...
    t.create = function(e, i) {
        ...
        for (var a in i) {
            ...
            } else "styles" === a ? "object" === (void 0 === s ? "undefined" : Et(s)) && Object.keys(s).map(function(t) {
                n.style[t] = s[t]
    ...
    var Rt = {
        ...
        Vt = 2,
        Ut = 7,
        Gt = ["light-blue", "blue", "violet", "red", "orange", "yellow", "green", "light-green", "purple", "magenta", "light-grey", "dark-grey"],
        qt = {
            bar: Gt,
            line: Gt,
            pie: Gt,
        ...
        Jt = function() {
            function e(t) {
                var i = t.parent,
                    ...
                    a = t.colors,
                    s = void 0 === a ? [] : a;
                _t(this, e), this.parent = n, this.colors = s, this.titleName = "", this.titleValue = "", this.listValues = [], this.titleValueFirst = 0, this.x = 0, this.y = 0, this.top = 0, this.left = 0, this.setup()
            }
            return zt(e, [{
                key: "setup",
                value: function() {
        ...
        de = ".chart-container{position:relative;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI','Roboto','Oxygen','Ubuntu','Cantarell','Fira Sans','Droid Sans','Helvetica Neue',sans-serif}.chart-container .axis,.chart-container .chart-label{fill:#555b51}.chart-container .axis line,.chart-container .chart-label line{stroke:#dadada}.chart-container .dataset-units circle{stroke:#fff;stroke-width:2}.chart-container .dataset-units path{fill:none;stroke-opacity:1;stroke-width:2px}.chart-container .dataset-path{stroke-width:2px}.chart-container .path-group path{fill:none;stroke-opacity:1;stroke-width:2px}.chart-container line.dashed{stroke-dasharray:5,3}.chart-container .axis-line .specific-value{text-anchor:start}.chart-container .axis-line .y-line{text-anchor:end}.chart-container .axis-line .x-line{text-anchor:middle}.chart-container .legend-dataset-text{fill:#6c7680;font-weight:600}.graph-svg-tip{position:absolute;z-index:99999;padding:10px;font-size:12px;color:#959da5;text-align:center;background:rgba(0,0,0,.8);border-radius:3px}.graph-svg-tip ul{padding-left:0;display:flex}.graph-svg-tip ol{padding-left:0;display:flex}.graph-svg-tip ul.data-point-list li{min-width:90px;flex:1;font-weight:600}.graph-svg-tip strong{color:#dfe2e5;font-weight:600}.graph-svg-tip .svg-pointer{position:absolute;height:5px;margin:0 0 0 -5px;content:' ';border:5px solid transparent;border-top-color:rgba(0,0,0,.8)}.graph-svg-tip.comparison{padding:0;text-align:left;pointer-events:none}.graph-svg-tip.comparison .title{display:block;padding:10px;margin:0;font-weight:600;line-height:1;pointer-events:none}.graph-svg-tip.comparison ul{margin:0;white-space:nowrap;list-style:none}.graph-svg-tip.comparison li{display:inline-block;padding:5px 10px}",
        pe = void 0,
        fe = function() {
            function e(t, i) {
                if (_t(this, e), this.parent = "string" == typeof t ? document.querySelector(t) : t, !(this.parent instanceof HTMLElement)) throw new Error("No `parent` element to render on was provided.");
                ...
                var n = this.measures;
                this.setMeasures(i), this.title.length || (n.titleHeight = 0), this.config.showLegend || (n.legendHeight = 0), this.argHeight = i.height || n.baseHeight, this.state = {}, this.options = {}, this.initTimeout = Yt, this.config.isNavigable && (this.overlays = []), this.configure(i)
            }
            return zt(e, [{
                key: "prepareData",
                value: function(t) {
                ...
                value: function(t, e) {
                    var i = [];
                    return (t = (t || []).concat(qt[e])).forEach(function(t) {
                        var e = $t(t);
                        b(e) ? i.push(e) : console.warn('"' + t + '" is not a valid color.')
                    }), i
                }
            }, {
                key: "setMeasures",
                ...
                value: function() {
                    ...
                    this.baseHeight = t, this.height = t - o(this.measures), pe = this.boundDrawFn.bind(this), window.addEventListener("resize", pe), window.addEventListener("orientationchange", this.boundDrawFn.bind(this))
                }
            }, {
                key: "boundDrawFn",
                value: function() {
                ...
                value: function() {
                    window.removeEventListener("resize", pe), window.removeEventListener("orientationchange", this.boundDrawFn.bind(this))
                }
            }, {
                key: "setup",
                value: function() {
                ...
                value: function() {
                    ...
                    var t = this.measures;
                    this.svg = P(this.container, "frappe-chart chart", this.baseWidth, this.baseHeight), this.svgDefs = L(this.svg), this.title.length && (this.titleEL = H("title", t.margins.left, t.margins.top, this.title, {
                        fontSize: t.titleFontSize,
                        fill: "#666666",
                        dy: t.titleFontSize
                    }));
                    var e = s(t);
                    this.drawArea = T(this.type + "-chart chart-draw-area", "translate(" + r(t) + ", " + e + ")"), this.config.showLegend && (e += this.height + t.paddings.bottom, this.legendArea = T("chart-legend", "translate(" + r(t) + ", " + e + ")")), this.title.length && this.svg.appendChild(this.titleEL), this.svg.appendChild(this.drawArea), this.config.showLegend && this.svg.appendChild(this.legendArea), this.updateTipOffset(r(t), s(t))
                }
            }, {
                key: "updateTipOffset",
                value: function(t, e) {
                ...
                value: function() {
                    ...
                    }), n.length > 0 ? (at(this.container, this.svg, n), setTimeout(function() {
                        e.forEach(function(t) {
                            return t.make()
                        }), t.updateNav()
        ...
        ve = function(t) {
            function e(t, i) {
                return _t(this, e), jt(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, i))
            }
            return Ht(e, t), zt(e, [{
                key: "configure",
                value: function(t) {
                    Wt(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "configure", this).call(this, t), this.config.maxSlices = t.maxSlices || 20, this.config.maxLegendPoints = t.maxLegendPoints || 20
                }
            }, {
                key: "calc",
                value: function() {
        ...
        ke = function() {
            function t(e) {
                var i = e.layerClass,
                    ...
                    l = e.makeElements,
                    u = e.animateElements;
                _t(this, t), this.layerTransform = s, this.constants = r, this.makeElements = l, this.getData = o, this.animateElements = u, this.store = [], this.labels = [], this.layerClass = n, this.layerClass = "function" == typeof this.layerClass ? this.layerClass() : this.layerClass, this.refresh()
            }
            return zt(t, [{
                key: "refresh",
                value: function(t) {
        ...
        we = {
            ...
            percentageBars: {
                ...
                makeElements: function(t) {
                    ...
                    return t.xPositions.map(function(i, n) {
                        return E(i, 0, t.widths[n], e.constants.barHeight, e.constants.barDepth, t.colors[n])
                    })
                },
                animateElements: function(t) {
                    if (t) return []
            ...
            heatDomain: {
                ...
                makeElements: function(t) {
                    ...
                    return this.serializedSubDomains = [], t.cols.map(function(t, i) {
                        1 === i && e.labels.push(H("domain-name", o, -12, pt(n, !0).toUpperCase(), {
                            fontSize: 9
                        })), t.map(function(t, i) {
                            if (t.fill) {
                                var n = {
            ...
            barGraph: {
                ...
                makeElements: function(t) {
                    ...
                    return this.unitType = "bar", this.units = t.yPositions.map(function(i, n) {
                        return V(t.xPositions[n], i, t.barWidth, e.color, t.labels[n], n, t.offsets[n], {
                            zeroLine: t.zeroLine,
                ...
                animateElements: function(t) {
                    ...
                    return this.store.map(function(a, s) {
                        m = m.concat($(a, e[s], i[s], t.barWidth, n[s], {
                            zeroLine: t.zeroLine
                        }))
                    }), m
                }
            ...
            lineGraph: {
                ...
                makeElements: function(t) {
                    var e = this.constants;
                    return this.unitType = "dot", this.paths = {}, e.hideLine || (this.paths = G(t.xPositions, t.yPositions, e.color, {
                        heatline: e.heatline,
                        ...
                        return U(t.xPositions[n], i, t.radius, e.color, e.valuesOverPoints ? t.values[n] : "", n)
                ...
                animateElements: function(t) {
                    ...
                    var p = [];
                    return Object.keys(this.paths).length && (p = p.concat(Z(this.paths, e, i, t.zeroLine))), this.units.length && this.units.map(function(t, n) {
        ...
        Ae = function(t) {
            ...
            return Ht(i, t), zt(i, [{
                ...
                value: function(t) {
                    ...
                    i.height = i.height || 20, i.depth = i.depth || Vt, e.paddings.right = 30, e.legendHeight = 60, e.baseHeight = 8 * (i.height + .5 * i.depth)
                }
            }, {
                key: "setupComponents",
                value: function() {
                ...
                value: function() {
                    var t = this;
                    Wt(i.prototype.__proto__ || Object.getPrototypeOf(i.prototype), "calc", this).call(this);
                    var e = this.state;
        ...
        Pe = function(t) {
            ...
            return Ht(i, t), zt(i, [{
                key: "configure",
                value: function(t) {
                    Wt(i.prototype.__proto__ || Object.getPrototypeOf(i.prototype), "configure", this).call(this, t), this.mouseMove = this.mouseMove.bind(this), this.mouseLeave = this.mouseLeave.bind(this), this.hoverRadio = t.hoverRadio || .1, this.config.startAngle = t.startAngle || 0, this.clockWise = t.clockWise || !1
                }
            }, {
                key: "calc",
                value: function() {
                    ...
                    e.sliceTotals.map(function(i, o) {
                        ...
                        var b = 360 === u ? M(y, m, t.center, t.radius, a, h) : O(y, m, t.center, t.radius, a, h);
                ...
                value: function(t, i, n, a) {
                    if (t) {
                        var s = this.colors[i];
                        if (n) {
                            it(t, this.calTranslateByAngle(this.state.slicesProperties[i])), t.style.fill = m(s, 50);
                            var r = e(this.svg),
                                o = a.pageX - r.left + 10,
                                l = a.pageY - r.top - 10,
                        ...
                        } else it(t, "translate3d(0,0,0)"), this.tip.hideTip(), t.style.fill = s
                    }
                }
            }, {
                key: "bindTooltip",
        ...
        Le = function(t) {
            ...
            return Ht(e, t), zt(e, [{
                ...
                value: function() {
                    var t = this.state;
                    t.start = ut(this.data.start), t.end = ut(this.data.end), t.firstWeekStart = ut(t.start), t.noOfWeeks = ht(t.start, t.end), t.distribution = Ct(Object.values(this.data.dataPoints), 5), t.domainConfigs = this.getDomains()
                }
            }, {
                key: "setupComponents",
                value: function() {
                ...
                key: "getDomains",
                value: function() {
                    for (var t = this.state, e = [t.start.getMonth(), t.start.getFullYear()], i = e[0], n = e[1], a = [t.end.getMonth(), t.end.getFullYear()], s = a[0] - i + 1 + 12 * (a[1] - n), r = [], o = ut(t.start), l = 0; l < s; l++) {
                        var u = t.end;
                        if (!dt(o, t.end)) {
                ...
                value: function(t) {
                    ...
                    gt(e = ut(e) || ft(n, a), 1);
                    for (var o = ht(s, e), l = [], u = void 0, h = 0; h < o; h++) u = this.getCol(s, n), l.push(u), gt(s = new Date(u[ge - 1].yyyyMmDd), 1);
                    return void 0 !== u[ge - 1].dataValue && (gt(s, 1), l.push(this.getCol(s, n, !0))), r.cols = l, r
                }
            }, {
                key: "getCol",
                value: function(t, e) {
                    for (var i = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], n = this.state, a = ut(t), s = [], r = 0; r < ge; r++, gt(a, 1)) {
                        var o = {},
                            l = a >= n.start && a <= n.end;
                        i || a.getMonth() !== e || !l ? o.yyyyMmDd = lt(a) : o = this.getSubDomainConfig(a), s.push(o)
                    }
                    return s
                }
            }, {
        ...
        Te = function(t) {
            ...
            return Ht(i, t), zt(i, [{
                ...
                key: "prepareData",
                value: function() {
                    return Mt(arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this.data, this.type)
                }
            }, {
                key: "prepareFirstData",
                value: function() {
                    return Dt(arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this.data)
                }
            }, {
                key: "calc",
                value: function() {
                ...
                value: function(t) {
                    var e = kt(t, arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "false"),
                        i = this.height / Pt(e),
                        n = At(e) * i,
                ...
                value: function() {
                    ...
                    this.data.yMarkers && (this.state.yMarkers = this.data.yMarkers.map(function(e) {
                        return e.position = Lt(e.value, t.yAxis), e.options || (e.options = {}), e
                    })), this.data.yRegions && (this.state.yRegions = this.data.yRegions.map(function(e) {
                        return e.startPos = Lt(e.start, t.yAxis), e.endPos = Lt(e.end, t.yAxis), e.options || (e.options = {}), e
                    }))
                }
            }, {
                key: "getAllYValues",
                    ...
                    var t = this,
                        e = [
                            ...
                            ["xAxis", {
                                ...
                                var t = this.state;
                                return t.xAxis.calcLabels = Nt(this.width, t.xAxis.labels, this.config.xIsSeries), t.xAxis
                            }.bind(this)],
                            ["yRegions", {
                                width: this.width,
                                pos: "right"
                ...
                value: function() {
                    ...
                    e.datasets.length > 1 && (this.legendArea.textContent = "", e.datasets.map(function(e, i) {
                        var n = z(100 * i, "0", 100, t.colors[i], e.name, t.config.truncateLegends);
                ...
                value: function() {
                    ...
                    this.overlayGuides && this.overlayGuides.forEach(function(t) {
                        ...
                        e.overlay = ae[e.type](i), t.drawArea.appendChild(e.overlay)
                    })
                }
            }, {
                ...
                value: function(t, e) {
                    ...
                    Wt(i.prototype.__proto__ || Object.getPrototypeOf(i.prototype), "addDataPoint", this).call(this, t, e, n), this.data.labels.splice(n, 0, t), this.data.datasets.map(function(t, i) {
                ...
                value: function() {
                    ...
                    this.data.labels.length <= 1 || (Wt(i.prototype.__proto__ || Object.getPrototypeOf(i.prototype), "removeDataPoint", this).call(this, t), this.data.labels.splice(t, 1), this.data.datasets.map(function(e) {
                        e.values.splice(t, 1)
                    }), this.update(this.data))
                }
            }, {
        ...
        Ce = function(t) {
            ...
            return Ht(i, t), zt(i, [{
                key: "configure",
                value: function(t) {
                    Wt(i.prototype.__proto__ || Object.getPrototypeOf(i.prototype), "configure", this).call(this, t), this.mouseMove = this.mouseMove.bind(this), this.mouseLeave = this.mouseLeave.bind(this), this.hoverRadio = t.hoverRadio || .1, this.config.startAngle = t.startAngle || 0, this.clockWise = t.clockWise || !1, this.strokeWidth = t.strokeWidth || 30
                }
            }, {
                key: "calc",
                value: function() {
                    ...
                    e.sliceTotals.map(function(i, o) {
                        var l = r,
                            ...
                            m = void 0;
                        t.init ? (y = g ? g.startPosition : f, m = g ? g.endPosition : f) : (y = f, m = v);
                        var b = 360 === u ? N(y, m, t.center, t.radius, t.clockWise, h) : D(y, m, t.center, t.radius, t.clockWise, h);
                        e.sliceStrings.push(b), e.slicesProperties.push({
                            startPosition: f,
                            endPosition: v,
                            value: i,
                ...
                value: function(t, i, n, a) {
                    if (t) {
                        var s = this.colors[i];
                        if (n) {
                            it(t, this.calTranslateByAngle(this.state.slicesProperties[i])), t.style.stroke = m(s, 50);
                            var r = e(this.svg),
                                o = a.pageX - r.left + 10,
                                l = a.pageY - r.top - 10,
                                u = (this.formatted_labels && this.formatted_labels.length > 0 ? this.formatted_labels[i] : this.state.labels[i]) + ": ",
                        ...
                        } else it(t, "translate3d(0,0,0)"), this.tip.hideTip(), t.style.stroke = s
                    }
                }
            }, {
                key: "bindTooltip",
        ...
        Ne = {};
    return Ne.NAME = "Frappe Charts", Ne.VERSION = "1.2.0", Ne = Object.assign({}, Ne, De)
}();
...
tomorrow = mm + '/' + dd + '/' + yyyy;
$('#to_date').datepicker("setDate", tomorrow);

frappe.call({
    method: "l3harris.www.user_profile.get_latency_throughput",
    args: {},
    async: false,
    callback: function(r) {
        console.log(r.message);
        $("#latency_lable").html(r.message.latency[0].name)
        $("#latency_slider").slider({
            value: 0,
            min: 0,
            max: parseInt(r.message.latency.length) - 1,
            step: 1,
            change: function(event, ui) {
                $("#latency_lable").html(r.message.latency[ui.value].name)
            }
        });
        $("#throughput_lable").html(r.message.throughtput[0].name)
        $("#throughput_slider").slider({
            value: 0,
            min: 0,
            max: parseInt(r.message.throughtput.length) - 1,
            step: 1,
            change: function(event, ui) {
                $("#throughput_lable").html(r.message.throughtput[ui.value].name)
            }
        });
    }
})
...
$("#new_subscription").click(function() {
    ...
    frappe.call({
        method: "l3harris.www.user_profile.make_subscription",
        args: {
            "network_type": $("#network_type").val(),
            "network_location": $("#network_location").val(),
            "latency": $("#latency_slider").slider("option", "value"),
            "throughput": $("#throughput_slider").slider("option", "value"),
...
$("#calc_estimate").click(function(){
    frappe.call({
        method: "l3harris.www.user_profile.make_estimate",
        args: {
            "network_type": $("#network_type").val(),
            "network_location": $("#network_location").val(),
            "latency": $("#latency_slider").slider("option", "value"),
        ...
        callback: function(r) {
            console.log(r.message);
            $("#approx_cost").val(r.message);
            $("#approx_cost").parent().removeClass("hidden");
        }
    })
...
$("#ticket_submit").click(function(){
    frappe.call({
        method: "l3harris.www.user_profile.make_ticket",
        args: {
            "subject": $("#subs_tck").val(),
            "desc": $("#desc_tck").val(),
            "subsc": $("#subscription-selection").val()
        },
        callback: function(r) {
            console.log(r.message);
            window.location.reload();
